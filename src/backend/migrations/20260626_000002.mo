...
module {
  ...
  public func migration(old : OldActor) : NewActor {
    let migratedTickets = old.tickets.map<Nat, {
      id : Nat;
      title : Text;
      description : Text;
      status : {
...

    {
      ...
      var embeddings = old.embeddings;
      var crawledPages = old.crawledPages;
      var nextCrawledPageId = old.nextCrawledPageId;
      var aiConfigs = old.aiConfigs;
      var promptVersions = old.promptVersions;
      var nextPromptVersionId = old.nextPromptVersionId;
      var rateLimits = old.rateLimits;
      var auditLogs = old.auditLogs;
      var nextAuditLogId = old.nextAuditLogId;
      var feedbacks = old.feedbacks;
      var nextFeedbackId = old.nextFeedbackId;
    };
  };
};
